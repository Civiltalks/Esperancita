...
- [x] **Pendências paradas** — itens em `pendencias.md` com nome de terceiro parado 3+ dias dispara cobrança
- [x] **Mention sweep** — LinkedIn + Twitter + menções no Discord/Slack, só sinaliza se relevante
...
- # [ ] **News watch** — desativado (Bruno tem rotina própria de leitura)
